...
public class RequestManager implements LifecycleListener, ModelTypes<RequestBuilder<Drawable>> {
    ...
    public RequestBuilder<Bitmap> asBitmap() {
        return m8as(Bitmap.class).apply((BaseRequestOptions<?>) DECODE_TYPE_BITMAP);
    }

    public RequestBuilder<GifDrawable> asGif() {
        return m8as(GifDrawable.class).apply((BaseRequestOptions<?>) DECODE_TYPE_GIF);
    }

    public RequestBuilder<Drawable> asDrawable() {
        return m8as(Drawable.class);
    }
    ...
    public RequestBuilder<File> downloadOnly() {
        return m8as(File.class).apply((BaseRequestOptions<?>) DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    public RequestBuilder<File> asFile() {
        return m8as(File.class).apply((BaseRequestOptions<?>) RequestOptions.skipMemoryCacheOf(true));
    }

    public <ResourceType> RequestBuilder<ResourceType> m8as(Class<ResourceType> cls) {
