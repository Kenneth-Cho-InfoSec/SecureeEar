...
public class DeviceFileListDataSourceHandler extends FileListDataSourceHandler {
    @Override
    ...
    public DeviceFileListDataSourceHandler(FileNodeArrayManager fileNodeArrayManager, FileListWebDavCommandHandle fileListWebDavCommandHandle, IAcceptFileListDataDelegate iAcceptFileListDataDelegate) {
    ...
    private void getFileListForFolderPathHandler(String str, int i, boolean z) {
        ...
        Collections.sort(linkedList, new ComparatorFile());
