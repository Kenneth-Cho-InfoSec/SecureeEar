...
public class TransformativeImageView2 extends AppCompatImageView {
    ...
    public static float INIT_SCALE_FACTOR = MIN_SCALE_FACTOR;
    public static boolean IS_LAND_SCREEN = false;

    public TransformativeImageView2(Context context) {
        this(context, null);
    }

    public TransformativeImageView2(Context context, AttributeSet attributeSet) {
    ...
    public void initImgPositionAndSize2Land() {
        this.mMatrix.reset();
        refreshImageRect();
        ...
        this.mMatrix.postScale(f, f, this.mImageRect.centerX(), this.mImageRect.centerY());
        refreshImageRect();
        this.mMatrix.postRotate(90.0f, this.mImageRect.centerX(), this.mImageRect.centerY());
        this.mMatrix.postTranslate(((getRight() - getLeft()) / 2) - this.mImageRect.centerX(), ((getBottom() - getTop()) / 2) - this.mImageRect.centerY());
        applyMatrix();
        float f2 = this.mMinScaleFactor;
        if (f2 != UNSPECIFIED_SCALE_FACTOR) {
    ...
    */
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (motionEvent.getPointerCount() == 2) {
                ...
                this.mCanDrag = !this.mIsTuoluoyi;
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:14:0x0028 A[PHI: r1 r2
  0x0028: PHI (r1v2 float) = (r1v1 float), (r1v3 float) binds: [B:13:0x0026, B:10:0x001d] A[DONT_GENERATE, DONT_INLINE]
  0x0028: PHI (r2v2 float) = (r2v1 float), (r2v3 float) binds: [B:13:0x0026, B:10:0x001d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private class MatrixRevertAnimator extends ValueAnimator implements ValueAnimator.AnimatorUpdateListener {
        ...
        MatrixRevertAnimator() {
            setFloatValues(0.0f, TransformativeImageView2.MIN_SCALE_FACTOR);
    ...
    public void setmImageRect(RectF rectF) {
