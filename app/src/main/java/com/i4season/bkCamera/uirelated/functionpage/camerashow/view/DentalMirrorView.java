...
public class DentalMirrorView extends BaseCameraView implements View.OnClickListener, TransformativeImageView.onTouchCallBack, BottomView.OnScrollerChangeListener {
    ...
    static int access$108(DentalMirrorView dentalMirrorView) {
    ...
    private void initView(boolean z) {
        View viewInflate;
        if (!z) {
            viewInflate = inflate(this.mContext, C0413R.layout.layout_dental_mirror, null);
        } else {
            viewInflate = inflate(this.mContext, C0413R.layout.layout_dental_mirror_land, null);
        }
        removeAllViews();
        addView(viewInflate);
    ...
    private void initData(boolean z, boolean z2) {
        ...
        if (setLanguage.equals(Strings.LANGUAGE_SPANISH)) {
            this.mGyroscopeOnTv.setTextSize(10);
            this.mGyroscopeOffTv.setTextSize(10);
        } else if (setLanguage.equals(Strings.LANGUAGE_PORTUGUESE)) {
    ...
    private void wideOrFocus(boolean z) {
        if (z) {
            if (this.mIsLand) {
                this.mGyroscopeOffRl.setBackgroundResource(C0413R.drawable.shape_white_bottom_corner30);
                this.mGyroscopeOnRl.setBackground(null);
            } else {
                this.mGyroscopeOffRl.setBackgroundResource(C0413R.drawable.shape_white_right_corner30);
                this.mGyroscopeOnRl.setBackground(null);
            }
        ...
        if (this.mIsLand) {
            this.mGyroscopeOnRl.setBackgroundResource(C0413R.drawable.shape_white_top_corner30);
            this.mGyroscopeOffRl.setBackground(null);
        } else {
            this.mGyroscopeOnRl.setBackgroundResource(C0413R.drawable.shape_white_left_corner30);
            this.mGyroscopeOffRl.setBackground(null);
        }
    ...
    private void functionChange(boolean z) {
        if (!z) {
            this.mTakePhotoOrRecorder.setImageResource(C0413R.drawable.ic_take_video);
        } else {
            this.mTakePhotoOrRecorder.setImageResource(C0413R.drawable.ic_take_photo);
        }
        this.isTakePhoto = z;
    }
    ...
    public void screenLock() {
        ...
        if (!Constant.CAMERASHOW_IS_SCREEN) {
            this.mLockIcon.setImageResource(C0413R.drawable.ic_screen_unlock);
            ...
            this.mLockIcon.setImageResource(C0413R.drawable.ic_screen_lock);
