...
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter {
    ...
    public Object getItem(int i) throws ArrayIndexOutOfBoundsException {
        Position positionTranslatePosition = translatePosition(i);
        if (positionTranslatePosition.mPosition == -1 || positionTranslatePosition.mPosition == -2) {
            return null;
        }
        return this.mDelegate.getItem(positionTranslatePosition.mPosition);
    }

    @Override
    public long getItemId(int i) {
        Position positionTranslatePosition = translatePosition(i);
        if (positionTranslatePosition.mPosition == -2) {
            return -1L;
        }
        if (positionTranslatePosition.mPosition == -1) {
            return -2L;
        }
        if (positionTranslatePosition.mPosition == -3) {
            return -3L;
        }
        return this.mDelegate.getItemId(positionTranslatePosition.mPosition);
    }
    ...
    public int getItemViewType(int i) {
        ...
        int itemViewType = this.mDelegate.getItemViewType(positionTranslatePosition.mPosition);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        Position positionTranslatePosition = translatePosition(i);
        if (positionTranslatePosition.mPosition == -2) {
            HeaderFillerView headerFillerView = getHeaderFillerView(positionTranslatePosition.mHeader, view, viewGroup);
            View headerView = this.mDelegate.getHeaderView(positionTranslatePosition.mHeader, (View) headerFillerView.getTag(), viewGroup);
        ...
        View view2 = this.mDelegate.getView(positionTranslatePosition.mPosition, view, viewGroup);
    ...
    public boolean isEnabled(int i) {
        ...
        return this.mDelegate.isEnabled(positionTranslatePosition.mPosition);
    }
    ...
    protected Position translatePosition(int i) {
        ...
        while (i2 < numHeaders) {
            ...
            int iUnFilledSpacesInHeaderGroup = unFilledSpacesInHeaderGroup(i2);
            i3 = i6 - iUnFilledSpacesInHeaderGroup;
            i = i5 - (countForHeader + iUnFilledSpacesInHeaderGroup);
            if (i < 0) {
