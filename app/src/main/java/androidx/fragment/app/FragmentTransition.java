...
class FragmentTransition {
    ...
    */
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, BackStackRecord.C0144Op c0144Op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z2) {
        int i;
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        int i2 = z ? INVERSE_OPS[c0144Op.cmd] : c0144Op.cmd;
        boolean z7 = false;
        if (i2 == 1) {
            if (!z2) {
