...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = {C0001R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0001R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0001R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0001R.id.action_bar));
        }
    }
