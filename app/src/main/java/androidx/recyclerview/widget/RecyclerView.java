...
import androidx.recyclerview.C0198R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0198R.styleable.RecyclerView, i, 0);
            String string = typedArrayObtainStyledAttributes2.getString(C0198R.styleable.RecyclerView_layoutManager);
            if (typedArrayObtainStyledAttributes2.getInt(C0198R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = typedArrayObtainStyledAttributes2.getBoolean(C0198R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(C0198R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(C0198R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(C0198R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(C0198R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    */
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:105:0x0230 A[ADDED_TO_REGION] */
        /* JADX WARN: Removed duplicated region for block: B:107:0x0233  */
        /* JADX WARN: Removed duplicated region for block: B:18:0x0037  */
        /* JADX WARN: Removed duplicated region for block: B:27:0x005c  */
        /* JADX WARN: Removed duplicated region for block: B:29:0x005f  */
        /* JADX WARN: Removed duplicated region for block: B:72:0x0187 A[PHI: r1 r4
  0x0187: PHI (r1v12 androidx.recyclerview.widget.RecyclerView$ViewHolder) = 
 ...
 binds: [B:28:0x005d, B:58:0x0101] A[DONT_GENERATE, DONT_INLINE]
  0x0187: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:58:0x0101] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (RecyclerView.this.mState.isPreLayout()) {
                ...
                if (recycledView != null) {
                    ...
                    if (recycledView == null && (viewCacheExtension = this.mViewCacheExtension) != null && (viewForPositionAndType = viewCacheExtension.getViewForPositionAndType(this, i, itemViewType)) != null) {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0198R.styleable.RecyclerView, i, i2);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(C0198R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(C0198R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(C0198R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(C0198R.styleable.RecyclerView_stackFromEnd, false);
            typedArrayObtainStyledAttributes.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0198R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0198R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0198R.dimen.fastscroll_margin));
    }
