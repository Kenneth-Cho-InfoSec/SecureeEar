...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C02231 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() {
            ...
            public void run() {
                ...
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C02231.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C02231.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i == 3) {
                        C02231.this.val$callback.removeTile(next.arg1, next.arg2);
                    } else {
        ...
        C02231(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C02231(mainThreadCallback);
    }

    class C02242 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C02242.this.mQueue.next();
                    if (next != null) {
                        int i = next.what;
                        if (i == 1) {
                            C02242.this.mQueue.removeMessages(1);
                            C02242.this.val$callback.refresh(next.arg1);
                        } else if (i == 2) {
                            C02242.this.mQueue.removeMessages(2);
                            C02242.this.mQueue.removeMessages(3);
                            C02242.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        } else if (i == 3) {
                            C02242.this.val$callback.loadTile(next.arg1, next.arg2);
                        } else if (i == 4) {
                            C02242.this.val$callback.recycleTile((TileList.Tile) next.data);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                        }
                    } else {
                        C02242.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C02242(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C02242(backgroundCallback);
    }
