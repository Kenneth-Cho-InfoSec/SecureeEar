...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0100R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0100R.dimen.compat_notification_large_icon_max_height);
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (z5) {
                    remoteViews.setInt(C0100R.id.notification_background, "setBackgroundResource", C0100R.drawable.notification_bg_low);
                    remoteViews.setInt(C0100R.id.icon, "setBackgroundResource", C0100R.drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0100R.id.notification_background, "setBackgroundResource", C0100R.drawable.notification_bg);
                    remoteViews.setInt(C0100R.id.icon, "setBackgroundResource", C0100R.drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0100R.id.icon, 0);
                    remoteViews.setImageViewBitmap(C0100R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0100R.id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0100R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0100R.dimen.notification_small_icon_background_padding) * 2);
                    if (Build.VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0100R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, this.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0100R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0100R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0100R.id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    remoteViews.setImageViewBitmap(C0100R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0100R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0100R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0100R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0100R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0100R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0100R.id.text, this.mBuilder.mContentText);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0100R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0100R.id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0100R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0100R.id.info, resources.getString(C0100R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0100R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0100R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0100R.id.info, 8);
                if (this.mBuilder.mSubText != null || Build.VERSION.SDK_INT < 16) {
                    z4 = false;
                } else {
                    remoteViews.setTextViewText(C0100R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText != null) {
                        remoteViews.setTextViewText(C0100R.id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0100R.id.text2, 0);
                        z4 = true;
                    } else {
                        remoteViews.setViewVisibility(C0100R.id.text2, 8);
                        z4 = false;
                    }
                }
                if (z4 && Build.VERSION.SDK_INT >= 16) {
                    if (z2) {
                        remoteViews.setTextViewTextSize(C0100R.id.text, 0, resources.getDimensionPixelSize(C0100R.dimen.notification_subtext_size));
                    }
                    remoteViews.setViewPadding(C0100R.id.line1, 0, 0, 0, 0);
                }
                if (this.mBuilder.getWhenIfShowing() != 0) {
                    if (this.mBuilder.mUseChronometer && Build.VERSION.SDK_INT >= 16) {
                        remoteViews.setViewVisibility(C0100R.id.chronometer, 0);
                        remoteViews.setLong(C0100R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                        remoteViews.setBoolean(C0100R.id.chronometer, "setStarted", true);
                    } else {
                        remoteViews.setViewVisibility(C0100R.id.time, 0);
                        remoteViews.setLong(C0100R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                    }
                    z6 = true;
                }
                remoteViews.setViewVisibility(C0100R.id.right_side, !z6 ? 0 : 8);
                remoteViews.setViewVisibility(C0100R.id.line3, z3 ? 0 : 8);
                return remoteViews;
            }
            z3 = true;
            z6 = true;
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0100R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0100R.id.notification_main_column);
            remoteViews.addView(C0100R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0100R.id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0100R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0100R.id.title, 8);
            remoteViews.setViewVisibility(C0100R.id.text2, 8);
            remoteViews.setViewVisibility(C0100R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0100R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0100R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int iMin;
            boolean z2 = true;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0100R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0100R.id.actions);
            if (!z || this.mBuilder.mActions == null || (iMin = Math.min(this.mBuilder.mActions.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0100R.id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(C0100R.id.actions, i2);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0100R.id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0100R.layout.notification_action_tombstone : C0100R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0100R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0100R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0100R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0100R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0100R.id.action_container, action.title);
            }
            return remoteViews;
        }
    }
