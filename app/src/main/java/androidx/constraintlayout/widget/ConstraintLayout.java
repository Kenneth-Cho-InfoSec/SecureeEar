...
public class ConstraintLayout extends ViewGroup {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0096R.styleable.ConstraintLayout_Layout);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
                if (index == C0096R.styleable.ConstraintLayout_Layout_android_minWidth) {
                    this.mMinWidth = typedArrayObtainStyledAttributes.getDimensionPixelOffset(index, this.mMinWidth);
                } else if (index == C0096R.styleable.ConstraintLayout_Layout_android_minHeight) {
                    this.mMinHeight = typedArrayObtainStyledAttributes.getDimensionPixelOffset(index, this.mMinHeight);
                } else if (index == C0096R.styleable.ConstraintLayout_Layout_android_maxWidth) {
                    this.mMaxWidth = typedArrayObtainStyledAttributes.getDimensionPixelOffset(index, this.mMaxWidth);
                } else if (index == C0096R.styleable.ConstraintLayout_Layout_android_maxHeight) {
                    this.mMaxHeight = typedArrayObtainStyledAttributes.getDimensionPixelOffset(index, this.mMaxHeight);
                } else if (index == C0096R.styleable.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.mOptimizationLevel = typedArrayObtainStyledAttributes.getInt(index, this.mOptimizationLevel);
                } else if (index == C0096R.styleable.ConstraintLayout_Layout_constraintSet) {
            ...
            if (childAt2.getVisibility() == i3) {
                ...
                if (!layoutParams2.isGuideline && !layoutParams2.isHelper) {
                    ...
                    if (resolvedValue == 0 || resolvedValue2 == 0) {
                        ...
                        if (resolvedValue == 0 && resolvedValue2 == 0 && z6 && z7) {
                            i4 = i12;
                            j2 = 1;
                        } else {
                            i4 = i12;
    ...
    */
    protected void onMeasure(int i, int i2) {
                    ...
                    if (layoutParams.isHelper || layoutParams.isGuideline) {
                        ...
                        if (view.getVisibility() != 8 && (!z5 || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved())) {
                            if (layoutParams.width == -2 && layoutParams.horizontalDimensionFixed) {
                                iMakeMeasureSpec = getChildMeasureSpec(i6, paddingRight, layoutParams.width);
                            } else {
                            ...
                            if (measuredWidth != constraintWidget.getWidth()) {
                                ...
                                if (z6 && constraintWidget.getRight() > iMax) {
                            ...
                            if (measuredHeight != constraintWidget.getHeight()) {
                                ...
                                if (z7 && constraintWidget.getBottom() > iMax2) {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            int iResolveSizeAndState = resolveSizeAndState(width3, i, i3);
            int iResolveSizeAndState2 = resolveSizeAndState(height3, i2, i3 << 16) & 16777215;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private static class Table {
            ...
            static {
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintCircle, 2);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                map.append(C0096R.styleable.ConstraintLayout_Layout_android_orientation, 1);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                map.append(C0096R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
            }
        }
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.widget = new ConstraintWidget();
            this.helped = false;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0096R.styleable.ConstraintLayout_Layout);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
