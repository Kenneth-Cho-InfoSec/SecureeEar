...
public class ConstraintAnchor {
    ...
    public String toString() {
        return this.mOwner.getDebugName() + Constant.SMB_COLON + this.mType.toString();
    }
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor constraintAnchor) {
        ...
        switch (this.mType) {
            ...
            case NONE:
                return false;
            case LEFT:
                int i = C00921.f13x4c44d048[constraintAnchor.getType().ordinal()];
                return i == 3 || i == 7;
            case RIGHT:
                int i2 = C00921.f13x4c44d048[constraintAnchor.getType().ordinal()];
                return i2 == 2 || i2 == 7;
            case TOP:
                int i3 = C00921.f13x4c44d048[constraintAnchor.getType().ordinal()];
                return i3 == 5 || i3 == 8;
            case BOTTOM:
                int i4 = C00921.f13x4c44d048[constraintAnchor.getType().ordinal()];
                return i4 == 4 || i4 == 8;
            case CENTER_X:
                int i5 = C00921.f13x4c44d048[constraintAnchor.getType().ordinal()];
                return i5 == 2 || i5 == 3;
            case CENTER_Y:
                int i6 = C00921.f13x4c44d048[constraintAnchor.getType().ordinal()];
                return i6 == 4 || i6 == 5;
            default:
                throw new AssertionError(this.mType.name());
        }
